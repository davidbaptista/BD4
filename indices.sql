...
/* 
Optamos por criar um indice de hash denso e desordenado com chave de pesquisa num_doente na tabela consulta, 
...
/* 
Optamos por criar um indice bitmap denso e desordenado com base no atributo especialidade, dado que este apenas varia entre 6 valores e
...
Optamos por um indice hash denso e desordenado com a chave de pesquisa num_cedula na tabela consulta. Para facilitar a segunda parte 
do where obtamos um indice btree denso e desordenado dado que sao feitas comparacoes de menor e maior
*/
